...
public class AgencyRegisterController {
	...
	public String registerUser(@ModelAttribute("registerform") RegistrationEntity registration, BindingResult result, Model model,RedirectAttributes redirectAttributes) throws Exception  {
		...
		agencyregEntity=agencyService.save(agencyregEntity);
	...
	//================================================UPDATE TO ACTIVE AGENCIES===========================================================//
	  ...
	  { 
			...
			Registration regEntity=agencyService.isUserExist(registration.getEmail(),registration.getPassword());
